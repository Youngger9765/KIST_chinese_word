  ...
  <html>
    ...
    <body>
        <div class="container">
            ...
            <h1>部件拼貼</h1>
            <h2>請將右邊的部件按照筆畫順序拉到正確的位置</h2>

        </div>

        <div class="container">
            <h1> TODO: 還想不到怎麼實現（靠前端 + Data） </h1>
        </div>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        $("#next").click(function(){
            window.location = "https://dpnu7opif2.execute-api.us-east-1.amazonaws.com/dev/landing-page-4?name=${dynamicHtml}&ans=${ans}";
        });
    </script>
  </html>`;
